...
[![Tests](https://img.shields.io/badge/tests-626%20passing-3E4A5C)](#development--testing)
...
# Frontend: 155 unit tests, 109 E2E tests
cd frontend
npm test          # Vitest
...
| `GET` | `/api/analysis` | List analyses, optional ticker and SEC industry code filters, and pagination |
