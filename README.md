...
[![Tests](https://img.shields.io/badge/tests-652%20passing-3E4A5C)](#development--testing)
...
- **Corpus by sector:** the homepage counts every stored analysis by the SEC review office that classified the filer, and each sector opens the history filtered to it
...
# Frontend: 164 unit tests, 117 E2E tests
cd frontend
npm test          # Vitest
...
<details>
<summary><b>Eleven endpoints</b>: health, company and filing lookup, industry classification, XBRL financials, analysis, cited Q&A, indexing</summary>
...
| `GET` | `/api/analysis` | List analyses, optional ticker, SEC industry code and SEC review office filters, and pagination |
| `GET` | `/api/analysis/sectors` | Stored analyses counted by SEC review office, across the whole corpus |
